 ...
 */
@Service
public class ShoppingServiceUtil extends AbstractCredit {
    //业务参数
...
//    public static final String contentType = "all";//内容类型---需客户指定
    ...
    public static void main(String[] args) throws Exception {
        ...
        //启动信服务
        ShoppingServiceUtil service  = new ShoppingServiceUtil();
        service.startTask("123458678","230804199610160531","张正阳","15645181047");
...
//        System.out.println(data);
    ...
    public String startTask(String uid, String identityCardNo, String identityName, String username) throws Exception{
        //提交受理请求对象
        List<BasicNameValuePair> reqParam = new ArrayList<BasicNameValuePair>();
//        reqParam.add(new BasicNameValuePair("accessType", "h5"));//API授权
        ...
        reqParam.add(new BasicNameValuePair("loginType", "qr"));//账号
        reqParam.add(new BasicNameValuePair("sign", getSign(reqParam)));//请求参数签名

        //提交受理请求
        String json = doProcess("/taobao_report/v1/task", reqParam);
    ...
    public String query_state(String key) throws Exception{
        //提交受理请求对象
        List<BasicNameValuePair> reqParam = new ArrayList<BasicNameValuePair>();
        reqParam.add(new BasicNameValuePair("apiKey", apiKey));//API授权
        ...
        //提交受理请求
        String json = doProcess("/taobao_report/v1/task/status", reqParam);
...
//        }
    ...
    public String input(String key, String input) throws Exception{
        ...
        //提交受理请求
        String json = doProcess("/taobao_report/v1/task/input", reqParam);
    ...
    public String query_report(String key) throws Exception{
        ...
        //提交受理请求
        String json = doProcess("/taobao_report/v1/task/data", reqParam);
